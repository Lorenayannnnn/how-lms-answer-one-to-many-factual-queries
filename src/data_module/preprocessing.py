...
def tokenize(entry):
    ...
    unused_columns = ["target_answer_idx", "three_answers_start_end_idx", "relation_start_end_idx"]
    ...
    entry["three_answers_first_token_list"] = [three_answers_token_list[i][0] for i in range(3)]
